...
//action
import { getHashtag, deleteHashtag } from "../../Store/Hashtag/hashtag.action";
...
import { OPEN_HASHTAG_DIALOG } from "../../Store/Hashtag/hashtag.type";

//baseURL
import { baseURL } from "../../util/ServerPath";

import HashtagDialog from "../Dialog/HashtagDialog";
            ...
            <div class="col-xl-6 col-md-6 col-sm-12 col-12 ">
              <div class="breadcrumb-four float-right">
                <ul class="breadcrumb">
                  ...
                  <li class="active">
                    <a href="javscript:void(0);"> Hashtag </a>
                  </li>
                </ul>
              </div>
            </div>
