...
//action
import { getRedeemPlan, deleteRedeemPlan } from "../../Store/Service/action";
...
// type
import { OPEN_REDEEM_PLAN_DIALOG } from "../../Store/Service/types";
            ...
            <div class="col-xl-6 col-md-6 col-sm-12 col-12 ">
              <div class="breadcrumb-four float-right">
                <ul class="breadcrumb">
                  ...
                  <li class="active">
                    <a href="javscript:void(0);"> Service List </a>
                  </li>
                </ul>
              </div>
            </div>
