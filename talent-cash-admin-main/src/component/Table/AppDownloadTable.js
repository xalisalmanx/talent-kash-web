...
//action
import { getRedeemPlan, deleteRedeemPlan } from "../../Store/AppDownload/action";
...
// type
import { OPEN_REDEEM_PLAN_DIALOG } from "../../Store/AppDownload/types";
...
import AddAppDownloadDialog from "../Dialog/AddAppDownloadDialog";
            ...
            <div class="col-xl-6 col-md-6 col-sm-12 col-12 ">
              <div class="breadcrumb-four float-right">
                <ul class="breadcrumb">
                  ...
                  <li class="active">
                    <a href="javscript:void(0);"> APP Downloads </a>
                  </li>
                </ul>
              </div>
            </div>
                        ...
                        {data.length > 0 ? (
                          (rowsPerPage > 0
                            ...
                            return (
                              <tr key={index}>
                                <td>{index + 1}</td>
                                <td>{data.androidDownload}</td>
                                <td>{data.iosDownload}</td>
                                {/* <td>{data.rupee}</td>
